...
const headCells = [
  ...
  { id: 'description', numeric: true, disablePadding: false, label: 'State' },
  { id: 'hsn', numeric: true, disablePadding: false, label: 'Country' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios
      .get(`http://inv.letseduvate.com/api/cities/?ordering=-id&page=1&page_size=10`)
      .then((res) => {
