...
const headCells = [
  ...
  { id: 'hsn', numeric: true, disablePadding: false, label: 'HSN' },
  { id: 'parent', numeric: true, disablePadding: false, label: 'Parent' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios
      .get(`http://inv.letseduvate.com/api/categories/?ordering=-id&page=1&page_size=10`)
      .then((res) => {
