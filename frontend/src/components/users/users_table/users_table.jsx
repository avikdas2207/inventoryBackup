...
const headCells = [
  ...
  { id: 'desc', numeric: true, disablePadding: false, label: 'First Name' },
  { id: 'unit', numeric: true, disablePadding: false, label: 'Last Name' },
  { id: 'phone', numeric: true, disablePadding: false, label: 'Mobile Number' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios
      .get(`http://inv.letseduvate.com/api/users/?ordering=-id&page=1&page_size=10`)
      .then((res) => {
                  ...
                  .map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{item.mobile_phone}</TableCell>
