...
const CustomerDetailsFrom = (props) => {
  ...
  const[isIndivitual,setIsIndivitual] = useState(false)
      ...
      <div className="customer-from">
        {value === "BASIC DETAILS" && (
          <div className="customer-basic-details-from">
            ...
            />{" "}
            <FormControlLabel
              className="is-indivutual"
              control={
                <Switch
                  checked={isIndivitual}
                  onChange={(e) => setIsIndivitual(e.target.checked)}
                />
              }
        ...
        {value === "CONTACT PERSON" && (
          <div className="customer-address-from">
            ...
            {conatctCount.map((eachCount) => {
              return <AddressFrom count={eachCount} addCount={setContact} />;
            })}
