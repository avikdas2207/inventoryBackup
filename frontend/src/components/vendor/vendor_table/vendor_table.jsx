...
const headCells = [
  ...
  { id: 'calories', numeric: true, disablePadding: false, label: 'GST Treatment' },
  { id: 'fat', numeric: true, disablePadding: false, label: 'Payment Terms' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Mobile Number' },
  { id: 'protein', numeric: true, disablePadding: false, label: 'Company Name' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
          axios
      .get(`http://inv.letseduvate.com/api/parties?&party_type=vendor`)
      .then((res) => {
                ...
                .map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{item.gst_treatment}</TableCell>
                      <TableCell align="right">{item.payment_terms}</TableCell>
