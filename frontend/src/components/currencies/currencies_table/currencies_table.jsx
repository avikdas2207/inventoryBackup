...
const headCells = [
  ...
  { id: 'is_base_currency', numeric: true, disablePadding: false, label: 'Is Default Currency' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios
      .get(`http://inv.letseduvate.com/api/currencies/?ordering=-id&page=1&page_size=10`)
      .then((res) => {
                  ...
                  .map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{item.is_base_currency}</TableCell>
