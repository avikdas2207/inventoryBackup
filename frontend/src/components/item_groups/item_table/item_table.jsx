...
const headCells = [
  ...
  { id: 'unit', numeric: true, disablePadding: false, label: 'Units' },
];
...
export default function EnhancedTable() {
  ...
  useEffect(() => {
    axios
      .get(`http://inv.letseduvate.com/api/itemgroups/?ordering=-id&page=1&page_size=10`)
      .then((res) => {
                  ...
                  .map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">{item.itemgroup_unit.name}</TableCell>
